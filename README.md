...
The skill covers v0.3.2 read-only candidate scans, omission-aware transport,
opaque-code review evidence, v2 enforcement decisions, and the additive posture
and capability fields. Its runner is review-only: mutation commands are denied
before the CLI is spawned. It does not claim that a
...
current-turn operator for R2/R3 mutations. For v0.3.2 candidates it passes a raw
